...
```{r echo=FALSE}
library(knitr)
df <- data.frame("Datasets" = c("Secondary school profile", "Secondary school census", "Secondary school admission", "Vaccination", "Broadband speed", 
                                "Property price paid",
                 ...
                 "Raw_data_contained" = c("100%", "100%", "100%", "90%", "100%", "100%", "6.9%", "20%", "100%", "100%",
                                          "100%", "100%", "100%"), 
                 "Released" = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "Yes", "Yes", "Yes", "Yes")
)
kable(df)
```
